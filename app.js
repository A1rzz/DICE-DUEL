...
$("shuffleBeforeRoll").onclick=()=>shuffleOrder(true);
...
function render(){
  ...
  $("shuffleBeforeRoll").classList.toggle("hidden",!(my===1&&(game.max_players||2)===10&&game.status==="playing"&&!(game.history||[]).length));
